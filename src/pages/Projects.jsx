...
const ALL_PROJECTS = [
  ...
  },
  {
    ...
    desc: 'A collection of Data Structures and Algorithms (DSA) implemented in Java for practice and learning purposes. This repository is ongoing and will be updated regularly.',
  ...
  },
  {
    ...
    desc: 'A curated collection of Python programs ranging from basic language fundamentals and mathematical problems to advanced data structure implementations, CLI mini-projects (like a Hotel Management System with MySQL), and university course assignments.',
    tags: ['Python', 'MySQL', 'Data Structures', 'CLI'],
    accent: '#EAB308',
    accentLight: '#FDE047',
    flag: 'Python',
